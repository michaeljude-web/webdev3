...
<body>
    ...
    <div class="content">
        ...
        <section id="products">
            ...
            $countSql = "SELECT COUNT(*) FROM products WHERE bid_end_time > NOW() AND product_name LIKE :search"; // Updated query for active products
            ...
            "; // Updated query for active products
            ...
            if ($products): 
                foreach ($products as $product): ?>
                    <tr>
                        ...
                        <td>Active</td> <!-- Hardcoded status -->
                        <td>-</td> <!-- Placeholder for amount -->
                        <td>-</td> <!-- Placeholder for email -->
                        <td>-</td> <!-- Placeholder for winner -->
                        <td>
                ...
                <tr>
                    <td colspan="7">No active products found.</td>
                </tr>
            <?php endif; ?>
            </tbody>
        </table>
